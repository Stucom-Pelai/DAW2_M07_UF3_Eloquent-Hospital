...
@php
$setting = \App\Models\Settings::get()->toArray();
$settings = $setting[0];
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="logo padding">
                            <a href="{{ url('/') }}"><img src="{{ 'storage/'.$settings["logo"] ??  config("app.url").'images/logo.png' }}" alt=""></a>
                    ...
                    <div class="col-md-4">
                        <div class="footer-info padding">
                            <h3>CONTACT US</h3>
                            <p><i class="fa fa-map-marker" aria-hidden="true"></i>{{ $settings["address"] ?? 'distric abc P/O xyz sorana' }}
                            </p>
                            <p><i class="fa fa-paper-plane" aria-hidden="true"></i>{{ $settings["business_email"] ?? 'root@test.com' }}
                            </p>
                            <p><i class="fa fa-phone" aria-hidden="true"></i>{{ $settings["business_phone"] ?? '+93 12 34 56' }}</p>
                        </div>
                    </div>
                    @livewire('subscribe')
                </div>
